        ...
        <div className="border border-gray-300 bg-white mt-2">
          ...
          {canEdit && !srd.sampleDispatchedToBuyer && (
            <div className="grid grid-cols-12">
              <div className="col-span-2 bg-gray-50 border-r border-gray-300"></div>
              <div className="col-span-10 px-2 py-1.5">
                <Button onClick={handleSaveDispatchDetails} disabled={loading} className="h-7 text-xs bg-blue-600 hover:bg-blue-700 rounded-none">
        ...
        <div className="border border-gray-300 bg-white mt-2">
          ...
          <div className="px-2 py-2">
            {!srd.sampleDispatchedToBuyer ? (
              ...
              <div className="text-center py-3 bg-green-50 border border-green-200">
                <p className="text-xs text-green-700 font-medium">Sample Dispatched on {new Date(srd.sampleDispatchDate).toLocaleString()}</p>
              </div>
            )}
          </div>
        </div>
