    ...
    return (
        <div className="p-8 max-w-[297mm] mx-auto print:max-w-none bg-white">
            ...
            <div className="flex justify-between items-center mb-6 print:hidden">
                <h1 className="text-app-heading font-bold">SRD Report</h1>
                <button
            ...
            <div className="mb-4">
                <h2 className="text-app-heading font-bold text-center mb-2">SRD Status Report</h2>
                <div className="text-app-text text-center text-gray-600">
            ...
            <div className="mt-8 text-app-text text-gray-500 text-right print:fixed print:bottom-4 print:right-4">
