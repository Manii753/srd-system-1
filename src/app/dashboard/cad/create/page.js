      ...
      const response = await fetch('/api/srd', {
        ...
        body: JSON.stringify({
          ...
          dynamicFields: dynamicDefs.map(d => ({
            ...
            order: d.order || 0,
            parentHeading: d.parentHeading ? 
              (typeof d.parentHeading === 'object' ? d.parentHeading.name : null) : null,
            fieldVersion: new Date(),
            originalFieldId: d._id.toString()
          }))
        }),
      });
    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-app-heading font-semibold">CAD Fields</CardTitle>
            </CardHeader>
            <CardContent>
